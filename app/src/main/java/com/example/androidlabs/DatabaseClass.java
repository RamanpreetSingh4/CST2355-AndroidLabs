...
//    }
    ...
    public Cursor printCursor(){
        ...
        Log.i("Column numbers", Integer.toString(cursor.getColumnCount()));

        Log.i("Column Names", Arrays.toString(cursor.getColumnNames()));

        Log.i("Total Rows",Integer.toString(cursor.getCount()));

        Log.i("Each Instances",DatabaseUtils.dumpCursorToString(cursor));
